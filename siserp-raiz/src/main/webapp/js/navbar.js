...
class Navbar extends React.Component {
	...
	paraTelaEmpresas() {
		ReactDOM.render( <Empresas />, sistema.paginaElemento() );
	}
			...
			<nav className="navbar navbar-expand-sm navbar-dark bg-dark">				
				...
				<div className="collapse navbar-collapse" id="nav-content">   
					<ul className="navbar-nav">
						...
						{ sistema.usuario.tipo == 'RAIZ' &&  (
							<li className="nav-item">	
								<a className="nav-link" href="#" onClick={() => this.paraTelaEmpresas() }>Empresas</a>
							</li>
						) }
						...
						{ ( sistema.usuario.tipo == 'RAIZ' || 
							...
							<li className="nav-item">
								<a className="nav-link" href="#">Sedes</a>
							</li>
						) }
