	...
	render() {
		...
		return (
			<Container>
				...
				<Form>
					<Button variant="primary" className="float-end" onClick={(e) => this.paraRecursoForm(e)} >
							...
							{recursos.map((recurso, index) => {
								return (
									<tr key={index}>
										...
										<td>{recurso.nome}</td>
										<td>
											<button className="btn btn-success" onClick={(e) => this.editar(e, recurso.id)}>
												<i className="fa-solid fa-edit">&nbsp;</i>
												Editar
											</button>
										</td>
										<td>
											<button className="btn btn-danger" onClick={(e) => this.removerSeConfirmado(e, recurso.id)}>
				...
				<Row>
					<Col className="col-md-8">
						...
						<Card className="p-3">
							<Row>
								<Col>
									<button className="btn btn-outline-primary" onClick={(e) => this.paraTelaUsuarios(e)}>
