		...
		return (
			<Container>
				<Modal show={remocaoModalVisivel}>
					...
					<Modal.Footer>
						<Form>
							<Button variant="primary" onClick={(e) => remocaoModalCancelaFunc()}>
								Cancelar
							</Button>
							<Button variant="danger" className="mx-2" onClick={(e) => remocaoModalOkFunc()}>
								Remover
							</Button>
						</Form>
					</Modal.Footer>
				...
				{this.props.gettipo !== 'caixaid' && (
					<Form className="float-end">
						<Button variant="primary" onClick={(e) => this.paraTelaRegistro()}>
							...
							{lancamentos.map((lanc, index) => {
								return (
									<tr key={index}>
										...
										<td>{lanc.obs}</td>
										<td>
											<button className="btn btn-danger" onClick={(e) => this.removerSeConfirmado(e, lanc.id)}>
				...
				<Card className="p-3">
					<Form>
						<Button variant="primary" onClick={(e) => this.listar(e, true)}>
