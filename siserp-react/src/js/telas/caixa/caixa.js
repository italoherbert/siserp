				...
				<Row>
					<Col>
						<Form className="float-end">
							<Button variant="primary" onClick={(e) => this.paraTelaAbrirCaixa(e)}>
				...
				<Row>
					<Col>
						<Card className="p-3" style={{ fontSize: '1.2em' }}>
							...
							<div>
								<Form>
									<Button variant="primary" onClick={(e) => this.atualizaDadosHoje(e)}>
										<i className="fa-solid fa-rotate">&nbsp;</i>
										Atualizar dados
									</Button>
									<Button variant="primary" className="mx-2" onClick={(e) => this.paraTelaLancamentos(e)}>
