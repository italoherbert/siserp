		...
		return (
			<Container>
				...
				<Row>
					<Col>
						<Form>
							<Button className="float-start" variant="primary" onClick={(e) => this.paraCategoriaMaps(e)} >
								<i className="fa-solid fa-display">&nbsp;</i>
								Categorias
							</Button>
							<Button className="float-end" variant="primary" onClick={(e) => this.paraCadastroForm(e)} >
									...
									{produtos.map((item, index) => {
										return (
											<tr key={index}>
												...
												<td>
													<button className="btn btn-success" onClick={(e) => this.detalhes(e, item.id)}>
														<i className="fa-solid fa-circle-info">&nbsp;</i>
														detalhes
													</button>
												</td>
												<td>
													<button className="btn btn-danger" onClick={(e) => this.removerSeConfirmado(e, item.id)}>
