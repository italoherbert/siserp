	...
	render() {
		...
		return (
			<div>
									...
									{vendas.map((venda, index) => {
										return (
											<tr key={index}>
												...
												<td>
													<button type="button" className="btn btn-success" onClick={(e) => this.carregaParcelas(e, venda.id)}>
					...
					<Col>
						<Card className="p-3">
							...
							<Form>
								...
								<Button variant="primary" onClick={(e) => this.efetuarRecebimento(e)}>
				...
				<Card className="p-3">
					<Form>
						<button className="btn btn-outline-primary" onClick={(e) => this.paraTelaVendas(e)}>
