...
public class Lancamento {
	...
	public final static String RECEBIMENTO_CANCELADO = "Recebimento de conta cancelado.";
	public final static String RECEBIMENTO_RESTAURADO = "Recebimento de conta restaurado.";
